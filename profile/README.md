...
Cette organisation regroupe l'ensemble des **supports pédagogiques**, **ateliers pratiques** et **projets d'entraînement** utilisés dans le cadre de formations en développement web — du front au back, des bases HTML/CSS jusqu'à React, TypeScript et à la sécurité applicative.
...
Les dépôts les plus repris par la communauté (forks/stars) :

| Projet | Description | Stack |
|---|---|---|
| [**js2ts**](https://github.com/Antho-Instructor/js2ts) | Atelier de migration progressive d'un projet JavaScript vers TypeScript | ![](https://img.shields.io/badge/-JavaScript-F7DF1E?logo=javascript&logoColor=000&style=flat-square) `⑂ 6` |
| [**tp_quiz**](https://github.com/Antho-Instructor/tp_quiz) | TP de création d'une application quiz interactive en JS/DOM | ![](https://img.shields.io/badge/-HTML-E34F26?logo=html5&logoColor=fff&style=flat-square) `⑂ 6` `★ 1` |
| [**livedemo-dom**](https://github.com/Antho-Instructor/livedemo-dom) | Démo live de manipulation du DOM en JavaScript vanilla | ![](https://img.shields.io/badge/-HTML-E34F26?logo=html5&logoColor=fff&style=flat-square) `⑂ 4` |
| [**Authentification**](https://github.com/Antho-Instructor/Authentification) | Atelier d'implémentation d'un système d'authentification (JWT/sessions) | ![](https://img.shields.io/badge/-JavaScript-F7DF1E?logo=javascript&logoColor=000&style=flat-square) `⑂ 4` |
| [**findYourHome**](https://github.com/Antho-Instructor/findYourHome) | Projet fil-rouge type "immobilier" pour mise en pratique front complète | ![](https://img.shields.io/badge/-HTML-E34F26?logo=html5&logoColor=fff&style=flat-square) `⑂ 3` |

<br/>

## 📚 Tous les dépôts par thématique

<details open>
<summary><b>🎓 Ateliers actifs (workshops)</b></summary>
<br/>
...
<details>
<summary><b>🚀 Déploiement & projets fullstack</b></summary>
<br/>
...
| Dépôt | Description |
|---|---|
| [OC_Init-react](https://github.com/Antho-Instructor/OC_Init-react) | Initiation à React |
...
| [work-with-api-development](https://github.com/Antho-Instructor/work-with-api-development) | Atelier de consommation et développement d'API |

</details>

<details>
<summary><b>🛠️ Fondamentaux HTML / CSS / JS & TP courts</b></summary>
<br/>
...
| [livedemo-dom](https://github.com/Antho-Instructor/livedemo-dom) | Démo live de manipulation du DOM |
| [tp_quiz](https://github.com/Antho-Instructor/tp_quiz) | Application quiz interactive |
| [debug_project](https://github.com/Antho-Instructor/debug_project) | Projet d'entraînement au debugging JavaScript |
| [MEP_JS-PHP](https://github.com/Antho-Instructor/MEP_JS-PHP) | Mise en pratique JavaScript/PHP |
| [Test_jest-express](https://github.com/Antho-Instructor/Test_jest-express) | Tests unitaires Jest sur une API Express |
| [testUnitaireJS](https://github.com/Antho-Instructor/testUnitaireJS) | Atelier de tests unitaires en JavaScript |
...
Ces dépôts sont ouverts aux apprenant·e·s : n'hésitez pas à **forker**, **ouvrir une issue** si vous repérez un énoncé ambigu, ou à proposer une **PR** avec votre solution pour comparer les approches.
